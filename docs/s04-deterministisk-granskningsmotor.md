...
- [ ] **S01 [OC01] [TI01,TI09] Korrekt dokument ger uppfylld på hela motorns regelset**
...
- [ ] **S02 [OC01,OC02,OC03] [TI02,TI08] Metadatafynd utan självrättning – AD-KONTAKT-5**
...
- [ ] **S03 [OC01,OC02,OC04] [TI03,TI08] Uppslagsfynd med föreskrivet rättningsförslag – AD-KONTAKT-2**
...
- [ ] **S04 [OC01,OC02,OC04] [TI04,TI08] Klassificeringsuppslag ger fynd vid okänd process – AR-PROCESS-1**
...
- [ ] **S05 [OC01,OC02] [TI05,TI08] Datummismatch mot dokumenttext – AD-DATUM-1**
...
- [ ] **S06 [OC01,OC02] [TI06,TI08] Filanalysfynd – FIL-ZIP-1 och FIL-ANTAL-1**
...
- [ ] **S07 [OC01] [TI06] Ej tillämplig vid saknade filer, utom FIL-ANTAL-1**
...
- [ ] **S08 [OC01,OC02] [TI07] Eskalering utan AI – AD-SEKRETESS-1**
...
- [ ] Motorns handler-set täcker exakt S04:s regel-ID:n (16 M/M+L-rader plus 6 FIL-rader = 22, se Technical Overview) och stäms av mot de 22 regel-ID:n som `testcases.json` refererar (S04:s riskSummary-mitigation).
- [ ] Ingen handler finns för en ren C/H-regel (AR-TITEL-1/3/4, AR-KONTAKT-1, AD-TITEL-1/3/4) i denna motor.
- [ ] Motorn är en ren funktion `(dokument, regelkatalog, referensdata) -> RuleOutcome[]`; den skriver aldrig till dokument, ärende, filer eller logg.
- [ ] Ingen Claude/Anthropic API-klient importeras eller anropas av denna modul.
...
- [ ] **TI01** Motorn laddar S01:s katalog och referensdata och validerar sin egen regel-täckning
...
- [ ] **TI02** Rena metadata-handlers utvärderar AD-KONTAKT-1/3/5, AR-KONTAKT-3, AD-GODKANNANDE-1
...
- [ ] **TI03** Uppslagshandlers mot kontaktregistret utvärderar AR-/AD-KONTAKT-2 och AR-/AD-KONTAKT-4
...
- [ ] **TI04** Uppslagshandlers mot klassificeringsstrukturen utvärderar existens-/tillhörighetsdelen av AR-PROCESS-1 och AD-HANDLINGSTYP-1
...
- [ ] **TI05** Metadatajämförbara delvillkor för AD-DATUM-1 och AD-KATEGORI-1
...
- [ ] **TI06** Filanalyshandlers utvärderar samtliga 6 FIL-regler från S03:s inlästa fil-flaggor
...
- [ ] **TI07** AD-SEKRETESS-1-handlern flaggar Mänsklig bedömning utan AI-anrop
...
- [ ] **TI08** Varje fynd från TI02-TI07 sätts samman enligt FR6:s fyndform
...
- [ ] **TI09** Motorn returnerar exakt ett utfall per S04-ägt regel-ID per körning
